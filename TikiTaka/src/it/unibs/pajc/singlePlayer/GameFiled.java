...
public abstract class GameFiled  implements GameFieldInterface {
    ...
    public final void positionStart() {
            ...
            objectsPiece[0] = (new Piece(40, 500, 0, "Pedina1HD.png", "T1"));
            objectsPiece[1] = (new Piece(40, 170, 70, "Pedina1HD.png", "T1"));
            objectsPiece[2] = (new Piece(40, 170, -70, "Pedina1HD.png", "T1"));
            objectsPiece[3] = (new Piece(40, 350, 180, "Pedina1HD.png", "T1"));
            objectsPiece[4] = (new Piece(40, 350, -180, "Pedina1HD.png", "T1"));
            objectsPiece[5] = (new Ball(18, 0, 0));
            objectsPiece[6] = (new Piece(40, -520, 0, "Pedina2HD.png", "T2"));
            objectsPiece[7] = (new Piece(40, -170, 70, "Pedina2HD.png", "T2"));
            objectsPiece[8] = (new Piece(40, -170, -70, "Pedina2HD.png", "T2"));
            objectsPiece[9] = (new Piece(40, -350, 180, "Pedina2HD.png", "T2"));
            objectsPiece[10] = (new Piece(40, -350, -180, "Pedina2HD.png", "T2"));
     ...
     */
    public final FieldObject checkClickAble(double xMouse, double yMouse) {
